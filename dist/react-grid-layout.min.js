!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      function s(t, e) {
        return (0, k.default)(
          L.default.Children.map(t, function(t) {
            return t.key;
          }),
          L.default.Children.map(e, function(t) {
            return t.key;
          })
        );
      }
      function u(t, e, n, r) {
        ...
        if (n && n > t.x) {
          if (t.x >= n) return !1;
        } else if (t.x >= e.x + e.w) return !1;
        if (n && n < t.x) {
          if (t.x <= n) return !1;
        } else if (t.x + t.w <= e.x) return !1;
        if (r && r > t.y) {
          if (t.y >= r) return !1;
        } else if (t.y >= e.y + e.h) return !1;
        if (r && r < t.y) {
          if (t.y <= r) return !1;
        } else if (t.y + t.h <= e.y) return !1;
        return !0;
      }
      function l(t, e, n) {
        for (
          var r = m(t), o = O(t, e), a = Array(t.length), s = 0, u = o.length;
          s < u;
          s++
        ) {
          var l = i(o[s]);
      ...
      function g(t, e, n, r, o) {
        var a = Math.abs(n - e.x) >= t.w || e.x + e.w === o || 0 === e.x,
          i = n === e.x,
          s = Math.abs(r - e.y) >= t.h,
          u = r === e.y;
        return (a && u) || (s && i);
      }
      function m(t) {
      ...
      function v(t, e, n, r, o, a, i, s, u, l) {
        ...
        "number" == typeof n && (e.x = n),
          ...
          (e.moved = !0);
        var p = O(t, s);
        ("vertical" === s && "number" == typeof r
          ? f >= r
          : "horizontal" === s && "number" == typeof n && c >= n) &&
          (p = p.reverse());
        var d = y(p, e);
        if (!i && a && d.length)
          return (
        ...
        if (i)
          for (
            ...
            if (
              ...
              if (
                (m && g(_, e, c, f, u) && (S = b(t, e, _, o, s, u, l, c, f)),
                !S)
              )
                return (e.x = c), (e.y = f), (e.moved = !1), t;
              t = S;
            }
          }
        else
          for (var R = 0, D = d.length; R < D; R++) {
            var j = d[R];
            C(
              "Resolving collision between " +
                e.i +
      ...
      function b(t, e, n, r, o, a, i, s, u) {
        var l = i || 0;
        r = !1;
        var c =
            s === e.x ? n.x : s < n.x ? Math.min(s, a - e.w + s) : n.x + e.w,
          f = u === e.y ? n.y : u < n.y ? Math.min(u, l - e.h + u) : n.y + e.h,
          p = { x: c, y: f, w: n.w, h: n.h, i: "-1" };
        if (!h(t, p)) return v(t, n, p.x, p.y, r, !1, !0, o, a, i);
      }
      function w(t, e, n, r, o, a, i) {
        var s = "horizontal" === o,
          u = "horizontal" !== o;
        if (r) {
          r = !1;
          ...
          if (!h(t, l))
            return (
              ...
              v(t, n, s ? l.x : void 0, u ? l.y : void 0, r, !1, !1, o, a, i)
            );
        }
        return v(
          t,
      ...
      function j(t, e, n, r) {
        ...
        var a = [];
        return (
          L.default.Children.forEach(e, function(e, n) {
            ...
            if (r) a[n] = i(r);
              ...
              s
                ? (N || E([s], "ReactGridLayout.children"),
                  (a[n] = i(z({}, s, { i: e.key }))))
      ...
      (e.bottom = o),
        ...
        (e.synchronizeLayoutWithChildren = j),
        (e.validateLayout = E),
          ...
          return (
            ...
            (e.prototype.onDrag = function(t, e, n, r) {
              ...
              if (f) {
                ...
                (s = (0, g.moveElement)(
                  ...
                  this.props.onDrag(s, i, f, p, o, a),
                  this.setState({
                    layout: (0, g.compact)(s, this.compactType(), l),
                    activeDrag: p
                  });
              }
            }),
            (e.prototype.onDragStop = function(t, e, n, r) {
              ...
              if (d) {
                ...
                var h = (0, g.compact)(s, this.compactType(), l),
          ...
          return (
            ...
            (e.prototype.mixinResizable = function(t, e) {
              var n = this.props,
                ...
                h = this.calcPosition(0, 0, 0, o - i).height,
                y = this.calcPosition(0, 0, s, u),
                g = this.calcPosition(0, 0, c, f),
                m = [y.width, y.height],
                v = [Math.min(g.width, p), Math.min(g.height, o ? h : 1 / 0)];
              return l.default.createElement(
                d.Resizable,
                {
                  width: e.width,
              ...
              return function(n, r) {
                ...
                if (i) {
                  ...
                  (v = Math.min(v, u - c)),
                    ...
                    (b = Math.max(Math.min(b, y), g)),
                    e.setState({ resizing: "onResizeStop" === t ? null : a }),
                    i.call(e, p, v, b, { e: n, node: o, size: a });
                }
              };
            }),
            (e.prototype.render = function() {
